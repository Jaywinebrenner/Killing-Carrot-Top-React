...
export const CreateCharacter = ({
  ...
  const [isTwoVisible, setIsTwoVisible] = useState(false);
    ...
    // 3 - After setting weapon text
        ...
        // 4 - Display weapon
        const 
          [isWeaponChoiceTextVisible, setIsWeaponChoiceTextVisible
        ] = useState(false)
          ...
          if (weapon === "Bare Hands") {
            return (
              <div>
                ...
                <div onClick={() => {setIsWeaponChoiceTextVisible(false); setIsSetArmorVisible(true)}}
    ...
    const renderSetArmor = () => {
      return (
        ...
        const 
          [isArmorChoiceTextVisible, setIsArmorChoiceTextVisible
        ] = useState(false)
    ...
    const renderArmorChoice = () => {
          ...
          if (armor === "Garden Pail Bucket Helmet") {
            return (
              <div>
                <h3>You slowly place the pail on your head- it's eye sockets aligning perfectly with the symetry of your forlorn, weathered face.</h3>
                <div onClick={() => {setIsArmorChoiceVisible(false); setChapterOne(true)}}
                 className="beginThyAdventureButtonText">
    ...
    const [isArmorChoiceVisible, setIsArmorChoiceVisible] = useState(false)
